...
const actions = [
  {
    title: 'Site Settings',
    description: 'Admin or Developer? You can configure maintenance-mode, rules, API-setting and all the other fun stuff, right here!',
    href: '#',
    icon: WrenchIcon,
  ...
  },
  {
    ...
    description: 'Planning a tournament, or just want to adjust the settings of the current one? This is the place to do it!',
    href: '#',
    icon: CheckBadgeIcon,
  ...
  {
    title: 'Manage User',
    description: 'In here you can set permissions for a user, allow them access to the API, or even ban them from the site!',
    href: '#',
    icon: UsersIcon,
  ...
  },
  {
    ...
    description: 'Want to see feedback from previous tournaments, or do you want to gather new feedback? This is the place to do it!',
    href: '#',
  ...
  {
    title: 'Guides',
    description: 'Collection of PDF-files, which can provide information on how to fulfill your role.',
    href: '#',
      ...
      {loading ? (
        ...
        <>
          {perm < 8 ? (
            ...
            <>
              <Header
                title={`${perm === 10 ? "Directors Panel"
                    : perm === 9 ? "Developer Panel"
                      : perm === 6 ? "Casters Panel"
                        : perm === 5 ? "Coordinator Panel"
                            ...
                            <div className="mt-8">
                              <h3 className="text-lg font-medium">
                                <a href={action.href} className="focus:outline-none">
                                  ...
                                  <span className="dark:text-white text-gray-900 transition-all duration-500">{action.title}</span>
                                </a>
                              </h3>
