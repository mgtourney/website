...
import TourneyCards from "@comp/Staff/tournaments/TournamentCards";
          ...
          {perm < 8 ? (
            ...
            <>
              <Header
                ...
                link={url}
                contents={`Tournament Panel | The Tournament Panel on ${process.env.PUBLIC_NAME}.`}
              />
              <div className="max-w-[1340px] mx-auto pt-10 px-4 sm:px-6 lg:px-8">
                <PageHeader title={`Tournament Panel`} />
                <>
