...
export default function TourneyContentCards({
  tourneyid,
}: {
  tourneyid: number;
}) {
    ...
    <>
          ...
          <h3 className="text-lg font-medium">
            <div className="focus:outline-none">
              ...
              <span className="dark:text-white text-gray-900 transition-all duration-500">
                Search for a tournament-team
              </span>
            </div>
          </h3>
          <div className="mt-1">
            <TeamSearch tourneyid={tourneyid} />
          </div>
        </div>
        <span
      ...
      >
        <div>
          <span
            className={
              "text-green-700 bg-green-50 dark:bg-[#1a2e19] rounded-lg inline-flex p-3 ring-4 ring-white dark:ring-[#141414] transition-all duration-500"
            }
          >
        ...
        <div className="mt-8">
          <h3 className="text-lg font-medium">
            <Link
              href={`/admin/tourneys/${tourneyid}/team/create`}
