...
export default function BottomBanner({ visible, headline, message, link, linkText, button }: { visible: boolean, headline: string, message: string, link: string, linkText: string, button: string }) {
                        ...
                        <div className="flex items-center justify-between flex-wrap">
                            ...
                            <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-2">
                                ...
                                >
                                    ...
                                    <XMarkIcon className="h-6 w-6 text-white" aria-hidden="true" onClick={() => setShowBanner(false)} />
                                </button>
                            </div>
                        </div>
                    </div>
